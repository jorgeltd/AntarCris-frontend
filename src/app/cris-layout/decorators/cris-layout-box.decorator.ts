...
import { CrisLayoutCollaborationBoxComponent } from '../cris-layout-matrix/cris-layout-box-container/boxes/collaboration/cris-layout-collaboration-box.component';
...
const layoutBoxesMap = new Map<LayoutBox, CrisLayoutBoxRenderOptions>([
  ...
  [ LayoutBox.COLLABORATION, { componentRef: CrisLayoutCollaborationBoxComponent, hasOwnContainer: false } as CrisLayoutBoxRenderOptions ],
]);
